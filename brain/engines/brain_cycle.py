...
_GATE_FLAGS = (
    "learning-cycle-overdue", "learning-cycle-running",
    "learning-cycle-failed", "learning-cycle-timeout", "cycle-empty",
)
...
def run_cycle():
    ...
    try:
        ...
        # PR326: unconditionally clear ALL gate flags on every exit path.
        # Outcome is tracked in state.json (last_cycle_outcome, fsm),
        # not in gate bins. No exit path may skip this block.
