...
Spec: `Khaan/brain/docs/decision-engine.html`. Orchestrator code: `engines/decision.py::dispatch()`.

## Manual invocation

```bash
python3 -c "import sys; sys.path.insert(0, '/home/ubuntu/.claude/brain'); from engines.decision import dispatch; import json; r = dispatch('$ARGUMENTS'); print(json.dumps(r, indent=2) if r else 'decision pipeline returned None')"
```
